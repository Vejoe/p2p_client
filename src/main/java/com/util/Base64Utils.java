...
public class Base64Utils {
    ...
    public static String ImageToBase64ByLocal(String imgFile) {// 将图片文件转化为字节数组字符串，并对其进行Base64编码处理
        ...
        return encoder.encode(data);// 返回Base64编码的字节数组字过符串
    }
...
// TODO: handle exception
    ...
    public static boolean photoValidation(String url){
        System.out.println("photoValidationCheck:"+url);
